...
def get_answer(
    ...
    for i in range(num_choices):
        ...
        for j in range(len(question["turns"])):
            ...
            if "yandexgpt" in model:
                output, _, _ = chat_completion_yandex(model, conv, temperature, max_tokens)
            else:
                output, _, _ = chat_completion_openai(model, conv, temperature, max_tokens)
